...
It is possible to export sketches using `export()`.
See Importing and Exporting Files for more details.
Importing of DXF files is supported as well using `importDXF()`.